      ...
      <div class="container mx-auto flex flex-col md:flex-row my-12 md:my-36">
        <div class="flex flex-col w-full lg:w-2/5 p-8">
          ...
          <p
            onClick={() =>
              openMap(
                "Leeward beach, Grace bay TKCA 1ZZ, Turks & Caicos Islands"
              )
            }
            class=" text-sm md:text-lg my-2 md:my-4"
          >
            <svg
          ...
          <p class=" text-sm md:text-lg my-2 md:my-4">
            ...
            <a href="mailto:clearbottomadventurestci9@gmail.com">
              clearbottomadventurestci9@gmail.com
            </a>
          </p>
          <p class=" text-sm md:text-lg my-2 md:my-4">
            <svg
            ...
            <a href="tel:(649) 246-9334">
              (649) 246-9334,{" "}
              <span>
                <a href="tel:(786) 329-3138">(786) 329-3138</a>
              </span>
            </a>
          </p>
          <br /> <br />
